...
public class Generator : MonoBehaviour
{
    ...
    public bool FindContent(int x, int y, int distanceBetweeenHouse)
    {
        bool cheker = true;
        for (int i = x - distanceBetweeenHouse;i < x + distanceBetweeenHouse;i++)
        {
            for (int j = y - distanceBetweeenHouse;j < y + distanceBetweeenHouse;j++)
            {
